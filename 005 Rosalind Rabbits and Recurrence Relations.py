...
that are defined by the recurrence relation Fn=Fn−1+Fn−2 (with F1=F2=1 to initiate the sequence). Although the sequence bears Fibonacci's name,
...
#Solution (1): 2 hrs of work. No ChatGPT. 100% selfmade code. Optimizing the values and making a working equation in "for loop" used max time (1hr 40 minutes).
...
if n>40 or n==0 or k>5:
    ...
    for i in range(n-1):
        c=(a*k)+b                                                                                                        #c= total population at 3rd month onwards
        globals()['o']=c
        a=b
        b=c
    print(o)
